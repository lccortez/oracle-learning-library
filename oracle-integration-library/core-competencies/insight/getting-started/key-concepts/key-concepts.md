...
## MODEL
A model is a business process, comprising of Milestone(s), a Unique Instance Indentifier and Alert(s)which passes through several states during its lifecycle. There are 8 states: 
